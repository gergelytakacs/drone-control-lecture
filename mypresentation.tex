...
\begin{figure}
\centering
  \includegraphics[width=100mm]{loop_Whatevs}\\
\end{figure}
\end{onlyenv}
...
\begin{figure}
\centering
  \includegraphics[width=60mm]{PID_P}\\
\end{figure}
\end{onlyenv}
...
\begin{figure}
\centering
  \includegraphics[width=60mm]{PID_I}\\
\end{figure}
\end{onlyenv}
...
\begin{figure}
\centering
  \includegraphics[width=60mm]{PID_D}\\
\end{figure}
\end{onlyenv}
...
\begin{figure}
\centering
  \includegraphics[width=\textwidth]{loop_Sampling}\\
\end{figure}
\end{frame}
